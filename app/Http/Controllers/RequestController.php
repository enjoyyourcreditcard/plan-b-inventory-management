...
{
    public function __construct(RequestService $requestService, PartService $partService, WareHouseService $warehouseService, NotificationService $notificationService)
    {
