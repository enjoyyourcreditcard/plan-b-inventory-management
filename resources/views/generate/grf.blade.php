...
<body style="font-family: 'Roboto', sans-serif;">
	...
	">Good Request Form</h4>
	<p style="text-align: center; margin-top:0px;padding-top:1px;font-size:12px;padding-bottom:15px">No: {{$grf->grf_code}}</p>
	<table style="text-align: left;">
		...
		<tr>
			<th style="text-align: left; font-size:13px">WO / IOM Number:</th>
			<td> : <span style="font-size:13px">-</span></td>
		</tr>
		
		<tr>
			<th style="text-align: left; font-size:13px">Tgl Diterbitkan</th>
			<td> : <span style="font-size:13px">{{$grf->created_at->format("d-m-Y")}}</span></td>
		...
		<tr>
			<th style="text-align: left; font-size:13px">Area</th>
			<td> : <span style="font-size:13px">{{$grf->user->regional}}</span></td>
	...
	<table class="tabel_data" style="margin-top: 20px">
		...
		<tr>
			...
			<th>{{$item->part ? $item->part->name : "-"}}</th>
			<th>{{$item->quantity}}</th>
			<th>{{$item->part ? $item->part->uom : "-"}}</th>
			<th>{{$item->remarks ? $item->remarks : "-"}}</th>
		</tr>
		@endforeach
		{{-- <tr>
			<th colspan="2">S</th>
