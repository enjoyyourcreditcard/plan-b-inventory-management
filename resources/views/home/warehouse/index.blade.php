    ...
    {{-- <div class="grid grid-cols-12 gap-6 mb-14">
        <div class="col-span-12 lg:col-span-12 mt-6">
            <div class="box p-16 overflow-hidden bg-primary intro-y">
                <div class=" w-full  text-white text-3xl -mt-3">Selamat
                    {{ Carbon\Carbon::now()->format('H') <= 10
                        ? 'Pagi'
                        : (Carbon\Carbon::now()->format('H') <= 14
                            ? 'Siang'
                ...
                <div class="col-span-12 xl:col-span-6 mt-6">
                    ...
                    <div class="mt-5">
                        ...
                        <a href="{{ route('warehouse.get.dashboard') }}"
                            class="intro-y w-full block text-center rounded-md py-4 border border-dotted border-slate-400 hover:bg-gray-200 dark:border-darkmode-300 text-slate-500">View
                            More</a>
                    </div>
                </div>
                {{-- ! --}}
                    ...
                    <div class="mt-5">
                        <div class="intro-y">
                            @foreach ($whreturn as $item)
                                <a
                                    href="{{ Route('get.whreturn.show.action.grf', str_replace('/', '~', $item->grf_code)) }}">
                                    <div class="box pr-4  mb-3 flex items-center zoom-in">
                                        <div class="ml-4 py-4 mr-auto">
                                            <div class="font-medium">{{ $item->grf_code }}</div>
                                            <div class="text-slate-500 text-xs mt-0.5">
