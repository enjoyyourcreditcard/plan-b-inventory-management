...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Add Segment</h2>
</div>
<form action="/segment" method="post">
            ...
            <div class="mt-5">
                ...
                <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        <input id="name" type="text" class="form-control uppercase" placeholder="Segment name" name="name" required>
                    </div>
                </div>
                ...
                <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        <select id="category_id" class="tom-select" name="category_id">
    ...
    <div class="flex justify-end flex-row gap-2 mt-5">
        <button type="button" class="btn py-3 border-slate-300 dark:border-darkmode-400 text-slate-500 md:w-52">Cancel</button>
