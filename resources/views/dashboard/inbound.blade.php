...
<div class="grid grid-cols-12 gap-6">
    ...
    <div class="col-span-12 mt-8">
        <div class="intro-y items-center h-10">
            <h2 class="text-lg font-medium mr-5">Dashboard Inbound</h2>
        </div>
    </div>
    ...
    <div class="col-span-12 grid grid-cols-12 gap-6">
        <div class="col-span-12 xl:col-span-6 mt-6">
            <div class="intro-y block sm:flex items-center h-10">
                <h2 class="text-lg font-medium truncate mr-5">Inbound report</h2>
            </div>
                ...
                <div class="flex flex-col md:flex-row md:items-center">
                    <div class="flex">
                        <div>
                            ...
                            <div class="mt-0.5 text-slate-500">Inbound barang baru</div>
                        </div>
                        <div
                        ...
                        <div>
                            ...
                            <div class="mt-0.5 text-slate-500">Inbound salah gudang</div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-span-12 xl:col-span-3 md:col-span-6 mt-6">
            <div class="intro-y flex items-center h-10">
                <h2 class="text-lg font-medium truncate mr-5">Presentasi type inbound</h2>
            </div>
            <div class="intro-y box p-5 mt-5">
                <div class="mt-3">
                    <div class="{{-- h-[213px] --}}">
                        <canvas id="chart-inbound-report" width="176" height="159"
        ...
        <div class="col-span-12 xl:col-span-3 md:col-span-6 mt-6">
            <div class="intro-y flex items-center h-10">
                <h2 class="text-lg font-medium truncate mr-5">Inbound terbesar</h2>
            </div>
            <div class="mt-5">
                <div class="intro-y">
