            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card">
                                                    ...
                                                    <tbody>
                                                            ...
                                                            @foreach ($requestForm as $key => $item)
                                                                <tr>
                                                                    ...
                                                                    <td>{{$item["count"]}}</td>
                                                                    <td>
                                                                        <button class="upload-sn btn btn-primary d-block w-100" type="button"
                        ...
                        {{-- * end alert validasi --}}
                        {{-- * modal --}}
                        {{-- <div class="modal fade" id="importexcel" data-bs-backdrop="static" data-bs-keyboard="false"
                        ...
                        {{-- * end modal --}}
                        {{-- * modal option --}}
                        <div class="modal modal-blur fade" id="upload" tabindex="-1" role="dialog"
                            aria-hidden="true">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <button type="button" class="btn btn-primary w-100"
                                                        data-toggle="modal" data-target="#inputSn"
                        ...
                        {{-- * end modal option --}}
                        {{-- ! modal excel --}}
                        <div class="modal modal-blur fade" id="importExcel"  data-bs-backdrop="static" data-bs-keyboard="false"
                            @if ($errors->any()) <div class="alert alert-danger">
                                <ul>
                                    @foreach ($errors->all() as $error)
                                        <li>{{ $error }}</li>
