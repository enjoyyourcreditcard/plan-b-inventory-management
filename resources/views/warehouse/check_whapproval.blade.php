                ...
                <table class="table table-report -mt-2 w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="whitespace-nowrap">Wh Quantity</th>
                    ...
                    <tbody>
                        @foreach ($requestForm as $key => $data)
                            <tr class="intro-x relative mr-3 sm:mr-6">
                                ...
                                <td class="w-8">
                                    <p class="font-medium whitespace-nowrap">{{ $data['quantity'] }}</p>
                                </td>
                                <td class="w-8">
                                    <p class="font-medium whitespace-nowrap">{{ $data['count'] }}</p>
                                </td>
            ...
            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div class="p-6 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Pilih Metode Tambah
                            Data</h3>
