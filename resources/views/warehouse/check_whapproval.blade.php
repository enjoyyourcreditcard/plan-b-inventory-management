...
<div class="">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="mb-2 d-flex gap-1">
                                    ...
                                    <p style="font-size: 15px">
                                        GRF CODE : <br> <strong>{{ $whapprov->grf_code }}</strong>
                                    </p>
                                </div>
                                <div class="mb-2 d-flex gap-1">
                                    ...
                                    <p style="font-size: 15px">
                                        Requester Name : <br> <strong>{{ $whapprov->user->name }}</strong>
                                    </p>
                                </div>
                                <div class="mb-2 d-flex gap-1">
                                    <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-md-8">
                <div class="card">
                    <form action="{{Route('post.approve.WH')}}" method="post" id="saveSn">
                        @csrf
                                                ...
                                                <table id="datatable"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="col">Warehouse Quantity</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{$item["count"]}}</td>
                                                            <td>
                                                                <button class="upload-sn btn btn-primary d-block w-100"
                                                                    type="button" data-bs-toggle="modal"
                                                                    data-bs-target="#upload"
                                                                    data-partid="{{ $item['part_id'] }}"
                                                                    data-partname="{{ $item['name'] }}"
                                                                    data-requestformid="{{ $item['id'] }}"
                                                                    data-icquantity="{{ $item['quantity']}}">Upload
                                                                    SN</button>
                                                            </td>
                                                        </tr>
                                                        @endforeach
...
<div class="d-flex">
    <div class="ms-auto my-3 mx-3">
        <button class="btn btn-primary" type="submit">
            Ready
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-send mx-2"
                viewBox="0 0 16 16">
                <path
...
{{-- * end alert validasi --}}
{{-- * modal --}}
{{-- <div class="modal fade" id="importexcel" data-bs-backdrop="static" data-bs-keyboard="false" @if ($errors->any())
    ...
    <div tabindex="-1" aria-labelledby="importexcel" aria-hidden="true">
            ...
            <div class="modal-content">
                <form action="{{ route('importexcel') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        @foreach ($whapprov->requestForms as $key => $item)
                        <input type="hidden" name="part_id[]" value="{{ $item->part_id }}">
                        <label for="" class="form-label">{{ $item->part->name }}</label>
    ...
    {{-- * end modal --}}
    {{-- * modal option --}}
    <div class="modal modal-blur fade" id="upload" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <button type="button" class="btn btn-success w-100" data-toggle="modal"
                                        data-target="#importExcel" data-bs-dismiss="modal">Bulk</button>
                                </div>
                                <div class="col-md-6">
                                    <button type="button" class="btn btn-primary w-100" data-toggle="modal"
                                        data-target="#inputSn" data-bs-dismiss="modal">Pieces</button>
                                </div>
        ...
        {{-- * end modal option --}}
        {{-- ! modal excel --}}
        <div class="modal modal-blur fade" id="importExcel" data-bs-backdrop="static" data-bs-keyboard="false"> {{-- @if
            ...
            <div tabindex="-1" role="dialog" aria-labelledby="importexcel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
            ...
            {{-- * modal input sn --}}
            <div class="modal modal-blur fade" id="inputSn" data-bs-backdrop="static" data-bs-keyboard="false">
                {{-- @if ($errors->any())
                <div class="alert alert-danger">
                    <ul>
                        @foreach ($errors->all() as $error)
                ...
                @endif --}}
                <div tabindex="-1" role="dialog" aria-labelledby="inputSn" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <form action="{{ route('inputsatuan') }}" method="POST" id="formPieces">
                                ...
                                <div id="input-pieces" class="modal-body">
                                </div>
                                <div class="modal-footer">
