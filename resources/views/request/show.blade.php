        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select name="warehouse_id" data-placeholder="Select warehouse" class="tom-select w-full"
                    ...
                    <option value="{{ $warehouse->id }}" {{ $warehouse->id == $grf->warehouse_id ? "selected" : "" }}>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="p-5 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                        class="bi bi-exclamation-circle text-slate-500 mx-auto mt-3" viewBox="0 0 16 16">
                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                        <path
                            d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z" />
                    </svg>
...
<div class="grid grid-cols-12 gap-6">
        ...
        <div class="box p-5 rounded-md">
            ...
            <div class="border-t border-slate-200/60 dark:border-darkmode-400 pt-5 mt-5 font-medium">
                <ul class="pricing-tabs nav nav-pills box rounded-full mx-auto overflow-hidden" role="tablist">
                    ...
                    @if( count( $requestForms ) && $grf->is_emergency == 1 ? $grf->file : $grf->warehouse_id )
                    ...
                    <form action="{{ Route( "request.post.add.item", $grf->id ) }}" method="POST">
                        ...
                        <div class="mt-3">
                            ...
                            <textarea name="remarks" class="form-control" rows="3"
                                placeholder="Request note.."></textarea>
                        </div>
                        <div
            ...
            <div
                ...
                <div class="intro-x relative flex items-center mb-3">
                    <div
                        ...
                        <div
                            class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden flex justify-center items-center border bg-white text-slate-400">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="intro-x relative flex items-center mb-3">
                    <div
                        ...
                        <div
                            class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden flex justify-center items-center border bg-white text-slate-400">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-box2 w-4 h-4" viewBox="0 0 16 16">
                                <path
                ...
                <div class="intro-x relative flex items-center mb-3">
                    <div
                        ...
                        <div
                            class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden flex justify-center items-center border bg-white text-slate-400">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-truck w-4 h-4" viewBox="0 0 16 16">
                                <path
                ...
                <div class="intro-x relative flex items-center mb-3">
                    <div
                        ...
                        <div
                            class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden flex justify-center items-center border bg-white text-slate-400">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-card-checklist w-4 h-4" viewBox="0 0 16 16">
                                <path
                ...
                <div class="intro-x relative flex items-center mb-3">
                    <div
                        ...
                        <div
                            class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden flex justify-center items-center border bg-white text-slate-400">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-envelope-check w-4 h-4" viewBox="0 0 16 16">
                                <path
                ...
                <div class="intro-x relative flex items-center mb-3">
                    <div
                        ...
                        <div
                            class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden flex justify-center items-center border bg-white text-slate-400">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-pencil w-4 h-4" viewBox="0 0 16 16">
                                <path
                ...
                @foreach ($grf->timelines->where( "status", "!=", "wh_approved" )->where( "status", "!=",
                "return_ic_approved" )->where( "status", "!=", "return_wh_approved" )->sortDesc() as $timeline)
                ...
                <div class="intro-x relative flex items-center mb-3">
                    ...
                    <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                        <div class="flex items-center">
                            ...
                            <div class="text-xs text-slate-500 ml-auto">{{ $timeline->created_at->format( "g:i A" ) }}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div
        ...
        <div class=" w-full">
            ...
            @if( Route::currentRouteName() == "request.get.emergency.detail" )
            <div class="intro-y col-span-12 overflow-auto 2xl:overflow-visible box p-5 mb-4">
                <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5 mb-5">
                    <div class="font-medium text-base truncate">Request Document</div>
                </div>

                <div class="w-full">
                    <form action="{{Route('request.put.update.file.emergency.request', $grf->id)}}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        @if($grf->file == null)
                        <div class="form-group">
                            <label class="text-base">Upload Dokumen </label>
                            <input type="file" class="form-control outline outline-1 p-3 mt-3" name="file">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="w-full flex">
                                <div class="w-full mt-3">
                                    <input type="text" value="{{$grf->file}}" class="form-control" name="file" disabled>
                                </div>
                                @if( $grf->status === "draft" )
                                <div class="mx-1 mt-3">

                                    <a class="flex items-center text-emerald-600 btn text-center"
                                        href="{{asset ('file/'.$grf->file)}}" target="blank" rel=" noopener noreferer">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-file-earmark w-4 h-4 mr-1"
                                            viewBox="0 0 16 16">
                                            <path
                                ...
                                <div class="ml-auto mt-3">
                                    <div class="flex justify-center items-center">
                                        <button form="form-delete" class="flex items-center text-danger btn text-center"
                                            type="submit">
