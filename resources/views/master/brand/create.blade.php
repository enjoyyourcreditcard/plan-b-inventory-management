...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Add Brand</h2>
</div>
            ...
            <div class="mt-5">
                ...
                <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        <select id="" class="tom-select" name="segment_id">
                ...
                <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                    ...
                    <div class="w-full mt-3 xl:mt-0 flex-1">
                        <input id="" type="text" class="form-control uppercase" placeholder="Brand name" name="name" required>
                    </div>
                </div>
