...
<nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/vendor">Master</a></li>
...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Add Vendor</h2>
</div>
<form action="{{route('vendor.post.store')}}" method="POST">
    @csrf
        ...
        <div class="mt-5">
            ...
            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                ...
                <div class="w-full mt-3 xl:mt-0 flex-1">
                    <input id="name" type="text" class="form-control" placeholder="Vendor Name" name="name" required>
                </div>
            </div>
            {{-- Input Start At --}}
            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
