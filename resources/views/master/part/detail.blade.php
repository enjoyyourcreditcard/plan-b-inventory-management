...
@section('content')
    <div class="intro-y box px-5 pt-5 mt-5">
        ...
        <div class="grid grid-cols-12  border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5 ">
            <div class="col-span-12 xl:col-span-3 flex justify-center items-center align-middle ">
                <div class="w-52 h-52 sm:w-52 sm:h-52 lg:w-52 lg:h-52 image-fit relative">
                    <img alt="Images" class="rounded-lg" src="{{ asset($part->img) }}">
                </div>
            </div>
            <div
                class="col-span-12 xl:col-span-9 mt-6 lg:mt-0 flex-1 px-5 border-l border-r border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0 ">
