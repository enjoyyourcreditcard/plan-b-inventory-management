...
<body class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
    ...
    <div class="flex overflow-hidden">
                ...
                */ --}}
                @if (Auth::user()->role == 'admin' || Auth::user()->role == 'inventory_control')
                        ...
                        <a href="javascript:;" class="side-menu">
                            ...
                            <div class="side-menu__title">
                                ...
                                <div class="side-menu__sub-icon "><svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon icon-tabler icon-tabler-chevron-down" width="36"
                    ...
                    <li>
                        <a href="javascript:;" class="side-menu">
                            <div class="side-menu__icon"><svg xmlns="http://www.w3.org/2000/svg" width="21"
                                    height="21" fill="currentColor" class="bi bi-truck" viewBox="0 0 16 16">
                                    <path
                        ...
                        <ul class="">
                            ...
                            <li>
                                <a href="{{ route('transaction.ic.view.outbound') }}"
                                    class="side-menu {{ Route::currentRouteName() == ' transaction.ic.view.outbound' ? 'side-menu--active' : '' }}">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                    <div class="side-menu__title"> Outbound </div>
                                </a>
                            </li>
                            <li>
                                <a href="{{ Route('warehouse.transfer.get.home') }}"
                                    class="side-menu {{ Route::currentRouteName() == 'warehouse.transfer.get.home' ? ' side-menu--active' : '' }}">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                    ...
                    <li>
                        <a href="side-menu-light-inbox.html" class="side-menu">
                            <div class="side-menu__icon"> <svg xmlns="http://www.w3.org/2000/svg" width="16"
                    ...
                    <li>
                        <a href="{{ Route('stock.get.home') }}"
                            ...
                            <div class="side-menu__icon"> <svg xmlns="http://www.w3.org/2000/svg" width="21"
                                    height="21" fill="currentColor" class="bi bi-box-seam" viewBox="0 0 16 16">
                                    <path
                    ...
                    <li>
                        <a href="javascript:;"
                            ...
                            <div class="side-menu__icon"> <svg xmlns="http://www.w3.org/2000/svg" width="21"
                                    height="21" fill="currentColor" class="bi bi-boxes" viewBox="0 0 16 16">
                                    <path
                        ...
                        <ul
                            ...
                            <li>
                                <a href="{{ Route('part.view.home') }}"
                                    class="side-menu {{ request()->is('part')
                                        ? "
                                                                                                        side-menu--active"
                                        : '' }}">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                            ...
                            <li>
                                <a href="{{ Route('segment.index') }}"
                                    class="side-menu {{ request()->is('segment')
                                        ? "
                                                                                                        side-menu--active"
                                        : '' }}">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                            ...
                            <li>
                                <a href="{{ Route('category.get.view') }}"
                                    class="side-menu {{ request()->is('category')
                                        ? "
                                                                                                        side-menu--active"
                                        : '' }}">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                            ...
                            <li>
                                <a href="{{ Route('brand.get.view') }}"
                                    class="side-menu {{ request()->is('brand')
                                        ? "
                                                                                                        side-menu--active"
                                        : '' }}">
                                    <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
        ...
        <div class="content">
                                ...
                                <a href="" class="flex items-center">
                                    <div
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            icon-name="inbox" class="lucide lucide-inbox w-4 h-4"
                                            data-lucide="inbox">
                                ...
                                <a href="" class="flex items-center mt-2">
                                    <div
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                            icon-name="users" class="lucide lucide-users w-4 h-4"
                                            data-lucide="users">
                                ...
                                <a href="" class="flex items-center mt-2">
                                    <div
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                            icon-name="credit-card" class="lucide lucide-credit-card w-4 h-4"
                ...
                <div class="intro-x dropdown mr-auto sm:mr-6">
                    @if ('')
                        <div class="dropdown-toggle notification cursor-pointer" role="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" icon-name="bell"
                                data-lucide="bell"
                            ...
                            <li>
                                <a href="" class="dropdown-item hover:bg-white/5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        icon-name="lock" data-lucide="lock"
                            ...
                            <li>
                                <a href="" class="dropdown-item hover:bg-white/5">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        icon-name="help-circle" data-lucide="help-circle"
            ...
            @endif
            @if (Session('success'))
                <div class="alert alert-success text-white alert-dismissible show flex items-center mb-2"
                    role="alert">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-exclamation-octagon" viewBox="0 0 16 16">
                        <path
