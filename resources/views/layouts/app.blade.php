                            ...
                            <div
                                ...
                                <div class="2xl:flex mt-5 mb-3">
                                    <div class="flex items-center justify-center sm:justify-start">
                                        ...
                                        <a class="text-slate-500 ml-4 2xl:ml-16" href=""> <i data-lucide="refresh-ccw"
                                                class="w-4 h-4"></i> </a>
                                    </div>
                                    <div
                            ...
                            <div class="mt-5">
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        ...
                                        <div class="ml-4 mr-auto">
                                            ...
                                            <div class="text-slate-500 text-xs mt-0.5">24 April 2021</div>
                                        </div>
                                        <div
                                ...
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        ...
                                        <div class="ml-4 mr-auto">
                                            ...
                                            <div class="text-slate-500 text-xs mt-0.5">22 April 2022</div>
                                        </div>
                                        <div
                                            class="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">
                                            137 Sales</div>
                                ...
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        ...
                                        <div class="ml-4 mr-auto">
                                            <div class="font-medium">Leonardo DiCaprio</div>
                                            <div class="text-slate-500 text-xs mt-0.5">12 August 2021</div>
                                        </div>
                                        <div
                                            class="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">
                                            137 Sales</div>
                                ...
                                <div class="intro-y">
                                    <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                        ...
                                        <div class="ml-4 mr-auto">
                                            ...
                                            <div class="text-slate-500 text-xs mt-0.5">6 October 2020</div>
                                        </div>
                                        <div
                                            class="py-1 px-2 rounded-full text-xs bg-success text-white cursor-pointer font-medium">
                                            137 Sales</div>
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone - HTML Admin Template"
                                                            ...
                                                            title="Uploaded at 9 March 2021">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <div class="flex">
                                                    <div class="w-10 h-10 image-fit zoom-in">
                                                        <img alt="Midone - HTML Admin Template"
                                                            class="tooltip rounded-full"
                                                            src="dist/images/preview-14.jpg"
                                                            title="Uploaded at 12 August 2021">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone - HTML Admin Template"
                                                            class="tooltip rounded-full"
                                                            src="dist/images/preview-13.jpg"
                                                            title="Uploaded at 12 April 2020">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone - HTML Admin Template"
                                                            class="tooltip rounded-full"
                                                            src="dist/images/preview-11.jpg"
                                                            title="Uploaded at 26 August 2021">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <div class="flex">
                                                    ...
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone - HTML Admin Template"
                                                            ...
                                                            title="Uploaded at 18 December 2022">
                                                    </div>
                                                    <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                        <img alt="Midone - HTML Admin Template"
                                                            class="tooltip rounded-full" src="dist/images/preview-8.jpg"
                                    ...
                                    <div class="intro-x relative flex items-center mb-3">
                                        ...
                                        <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                            ...
                                            <div class="text-slate-500 mt-1">Has changed <a class="text-primary"
                                                    href="">Nikon Z6</a> price and description</div>
                                        </div>
                                    </div>
                                    <div class="intro-x relative flex items-center mb-3">
                                        <div
                                        ...
                                        <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                            ...
                                            <div class="text-slate-500 mt-1">Has changed <a class="text-primary"
                                                    href="">Sony A7 III</a> description</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="intro-x">
                                        <div class="box px-5 py-3 mb-3 flex items-center zoom-in">
                                            ...
                                            <div class="ml-4 mr-auto">
                                                ...
                                                <div class="text-slate-500 text-xs mt-0.5">14 January 2021</div>
                                            </div>
