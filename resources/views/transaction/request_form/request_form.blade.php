                ...
                <div class="card-body text-center">
                  ...
                  <div class="h-5 fw-bold my-3">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor"
                      class="bi bi-pause-fill text-warning pb-2" viewBox="0 0 16 16">
                      <path
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor"
                      class="bi bi-check-lg text-success pb-2" viewBox="0 0 16 16">
                      <path
                    ...
                    <span class="h1 text-uppercase ">On progres</span>
                    @break
                    @case("wh_approved"){{--*! wh_approved --}}
                    <span class="h1 text-uppercase">On progres</span>
                    @break
                    @case("delivery_approved"){{--*! delivery_approved --}}
                    <span class="h1 text-uppercase">Ready Pickup </span>
                    @break
                    @case("return"){{--*! return --}}
                    <span class="h1 text-uppercase">Close </span>
                    @break
                    @case("user_pickup"){{--*! user_pickup --}}
            ...
            @if (count($requestForms->take(3)) < 3) <form action="/request-form" method="POST"
              ...
              <button class="card card-md bg-light" style="flex-grow: 1">
                ...
                <div class="card-body text-center d-flex flex-column w-100">
                  ...
                  <div class="display-5 fw-bold my-3 d-flex justify-content-center align-items-center"
                    style="flex-grow: 1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor"
