...
@section('content')
    <div class="intro-y chat grid grid-cols-12 gap-5 mt-5">
                ...
                <div id="chats" class="tab-pane active" role="tabpanel" aria-labelledby="chats-tab">
                    <div class="pr-1">
                        <div class="box px-5 pt-5 pb-1 mt-5">
                            ...
                            @if ($currentGrf->status == 'delivery_approved')
        ...
        {{-- react --}}
        <div id="inboundRecipientShow" class="table-responsive overflow-auto w-full col-span-12 lg:col-span-8 2xl:col-span-8" data-grfcode="{{ $currentGrf->id }}" data-status="{{ $currentGrf->status }}"></div>
        {{-- react --}}
        ...
        */ --}}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body p-0">
                        ...
                        <form action="{{ route('inbound.put.recipient', $currentGrf->id) }}" method="POST" class="px-5 pb-8 text-center">
                            @csrf
                            @method('PUT')
        ...
        <div id="modal-pieces" class="modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form id="form-pieces" action="{{ Route('inbound.post.pieces.recipient', $currentGrf->id) }}" method="POST">
                        @csrf
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-body p-10 text-center">
                        <form id="form-bulk" data-single="true" action="{{ route('inbound.post.bulk.recipient', $currentGrf->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
