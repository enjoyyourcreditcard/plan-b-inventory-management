            ...
            <div class="modal-body">
                ...
                <div class="p-5 pb-8 text-center">
                    <form action="{{ Route( 'warehouse.transfer.post' ) }}" method="POST">
                        @csrf
                        <input type="hidden" name="irf_code" value="{{ $irf_code }}">
                        <ul class="nav nav-boxed-tabs justify-center flex-col gap-4" role="tablist">
                            <li id="top-products-laravel-tab" class="nav-item flex flex-col flex-grow" role="presentation">
                                <button type="submit" name="type" value="transfer_rekondisi" disabled class="nav-link text-center w-auto mb-2 sm:mb-0 sm:mx-2 !rounded-full !bg-emerald-700 text-white transition duration-300 ease-in-out hover:!bg-slate-100 hover:!text-slate-500" data-tw-target="#top-products-laravel" aria-controls="top-products-laravel" aria-selected="true" role="tab">
                            ...
                            <li id="top-products-bootstrap-tab" class="nav-item flex flex-col flex-grow" role="presentation">
                                <button type="submit" name="type" value="transfer_antar_gudang" class="nav-link text-center w-auto mb-2 sm:mb-0 sm:mx-2 !rounded-full !bg-emerald-700 text-white transition duration-300 ease-in-out hover:!bg-slate-100 hover:!text-slate-500" data-tw-target="#top-products-bootstrap" aria-selected="false" role="tab">
...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
        ...
        <div class="w-full xl:w-auto flex items-center mt-3 xl:mt-0">
            <button class="btn btn-primary rounded-full shadow-md mr-2" data-tw-toggle="modal" data-tw-target="#modal-new-transfer">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
    ...
    <div class="intro-y col-span-12 overflow-auto 2xl:overflow-visible">
        <table class="table table-report -mt-2">
            <thead>
                <tr>
                    <th class="whitespace-nowrap">IRF CODE</th>
            ...
            <tbody>
                ...
                <tr class="intro-x">
                    <td class="w-40 !py-4">
                        <a href="" class="underline decoration-dotted whitespace-nowrap">{{ $irf->irf_code }}</a>
                    </td>
                    <td class="w-40">
                        <a href="" class="font-medium whitespace-nowrap">{{ isset( $irf->warehouse_id ) ? $irf->warehouse->name : "-" }}</a>
                        <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5">{{ $irf->timelines->where( "status", "submited" )->first() ? $irf->timelines->where( "status", "submited" )->first()->created_at : "" }}</div>
                    </td>
                    <td>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right mx-auto" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z" />
                        </svg>
                    </td>
                    <td class="w-40">
                        <div class="whitespace-nowrap">{{ isset( $irf->warehouse_destination ) ? $irf->warehouse_destination : "-" }}</div>
                    ...
                    <td class="text-center">
                        ...
                        @break
                        @default
                        <div class="flex items-center justify-center whitespace-nowrap text-slate-400">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="check-square" data-lucide="check-square" class="lucide lucide-check-square w-4 h-4 mr-2">
                                <polyline points="9 11 12 14 22 4"></polyline>
                                <path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"></path>
                            </svg> On progress..
                    ...
                    <td class="w-40 text-right">
                        <div class="pr-16">{{ $irf->total_stock }} stock</div>
                    </td>
                    <td class="table-report__action">
                        <div class="flex justify-center items-center">
                            <a class="flex items-center text-primary whitespace-nowrap mr-5" href="{{ Route( 'warehouse.transfer.get.detail', str_replace( '/' , '~' , $irf->irf_code )) }}">
