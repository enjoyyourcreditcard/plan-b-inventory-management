...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="-intro-x mr-auto hidden sm:flex">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Warehouse Detail Transfer</li>
        </ol>
    </nav>
@endsection
    ...
    <div class="intro-y chat grid grid-cols-12 gap-5 mt-5">
                            ...
                            <div class="flex mb-5 mt-8 ">
                                ...
                                <form action="{{ route('warehouse.post.changeStatus', $irf->id) }}" method="POST" class="w-full">
                                    ...
                                    <button type="submit" class="btn btn-primary w-full rounded-full">
                                        Submit
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-send mx-2"
        ...
        <div id="modal-pieces" class="modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form id="form-pieces" action="{{ Route('warehouse.transfer.post.pieces', $item->id) }}" method="POST">
                        @csrf
        ...
        <div id="modal-bulk" class="modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-body p-10 text-center">
                        <form id="form-bulk" data-single="true" action="{{ route('warehouse.transfer.post.bulk', $item->id) }}" method="POST"
