            ...
            <div class="modal-body">
                ...
                <select name="warehouse_destination" data-placeholder="Select warehouse" class="tom-select w-full"
                    ...
                    <option value="{{ $warehouse->name }}"
                        {{ $warehouse->name == $grf->warehouse_destination ? "selected" : "" }}>{{ $warehouse->name }}
                    </option>
                    @endforeach
                </select>
            </div>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex gap-6 justify-center items-center">
                                    <button class="btn-input-sn flex items-center text-slate-500 whitespace-nowrap"
                                        data-tw-toggle="modal" data-tw-target="#modal-pieces-bulk"
                                    ...
                                    <form action="{{ Route( "warehouse.transfer.delete", $transferForm->id ) }}"
                                        method="POST">
                                        @csrf
                                        @method( "DELETE" )
