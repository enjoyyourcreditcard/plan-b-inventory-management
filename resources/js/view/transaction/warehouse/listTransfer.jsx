...
function TransferList(props) {
    ...
    useEffect(() => {
        async function getData() {
            api.getWarehouseListTransfer(props.warehouse_id).then((response) => {
...
if (document.getElementById("listTransfer")) {
    const propsContainer = document.getElementById("listTransfer");
    const props = Object.assign({}, propsContainer.dataset);
    ReactDOM.render(
        <TransferList {...props} />,
        document.getElementById("listTransfer")
    );
}