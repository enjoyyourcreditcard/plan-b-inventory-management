...
function TransferApprov(props) {
    ...
    useEffect(() => {
        async function getData() {
            api.getInboundGiverShow(props.grf_code).then((response) => {
...
if (document.getElementById("inboundGiverShow")) {
    const props = {
        'grf_code': document.getElementById("inboundGiverShow").dataset.grfcode,
        'status': document.getElementById("inboundGiverShow").dataset.status
    };

    ReactDOM.render(
        <TransferApprov {...props} />,
        document.getElementById("inboundGiverShow")
    );
}
