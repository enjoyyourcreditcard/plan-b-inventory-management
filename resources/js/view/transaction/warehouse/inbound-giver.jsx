...
function InboundGiver(props) {
    ...
    useEffect(() => {
        async function getData() {
            api.getInboundGiverIndex(props.warehouse_id).then((response) => {
        ...
        () => [
            ...
            },
            {
                ...
                Cell: (tableProps) => (
                    <>
                        <span>
                            &nbsp;{tableProps.row.original.warehouse_destination}
                        </span>
                    </>
                ),
            },
            {
                ...
                Cell: (tableProps) => (
                    <>
                        <a className="text-emerald-600 flex items-center underline gap-1 decoration-dotted" href={ `/inbound/giver/` + tableProps.row.original.id }>
...
if (document.getElementById("inboundGiver")) {
    const propsContainer = document.getElementById("inboundGiver");
    const props = Object.assign({}, propsContainer.dataset);

    ReactDOM.render(
        <InboundGiver {...props} />,
        document.getElementById("inboundGiver")
    );
}