...
function RecipientList(props) {
    ...
    useEffect(() => {
        async function getData() {
            api.getWarehouseListRecipient(props.warehouse_destination).then((response) => {
    ...
    const columns = React.useMemo(
        () => [
            ...
            },
            {
                //Add this line to the column definition
                Header: "To Warehouse",
                accessor: "warehouse_destination",
                // style: { 'maxWidth': 10 },//Add this line to the column definition
                Cell: (tableProps) => (
                    <>
                        <a
...
if (document.getElementById("listRecipient")) {
    const props = {'warehouse_destination': document.getElementById("listRecipient").dataset.warehousedestination};
    ReactDOM.render(
        <RecipientList {...props} />,
        document.getElementById("listRecipient")
    );
}