...
function TransferApprov(props) {
    ...
    useEffect(() => {
        async function getData() {
            api.getInboundRecipientShow(props.irf).then((response) => {
    ...
    const columns = React.useMemo(
        () => [
            ...
            },
            {
                ...
                Cell: (tableProps) => (
                    <>
                        <span> { tableProps.row.original.brand_name } </span>
                    </>
                ),
            },
            {
                ...
                Cell: (tableProps) => (
                    <>
                        <span> {tableProps.row.original.inputed_quantity + ` / ` + tableProps.row.original.quantity + ` ` + tableProps.row.original.uom} </span>
                    </>
                ),
            },
            {
                ...
                Cell: (tableProps) => {
                    if (props.status == 'delivered') {
                        ...
                        if (!tableProps.row.original.is_inputed) {
...
if (document.getElementById("inboundRecipientShow")) {
    const props = {
        'irf': document.getElementById("inboundRecipientShow").dataset.irf,
