const grf_reject_ic = document.getElementById("grf-reject-confirmation-modal");
grf_reject_ic.addEventListener("show.tw.modal", function (event) {
    var url = new URL(document.URL);
    var grf_id = url.searchParams.get("grf_id");
    document.getElementById("grf_id_delete").value = grf_id;
});
...
//     var values = jQuery(".quantity_" + id)
//         .map(function () {
//             return $(this).val();
//         })
//         .get();
